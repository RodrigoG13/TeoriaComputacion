...
class Tablero:
    def __init__(self, dimension, tablero, indices, num_movs, cant_fichas=1):
        ...
        self.tiempo_siguiente_movimiento = 3
    ...
    def revisar_existencia_movs(self, num_mov, casilla_actual, evitar, casilla):
        if casilla == 1:
            print("casilla 1")
            print(self.movs_casillas_ficha1[int(num_mov)])
            print(f"casilla_act = {int(casilla_actual)}")
            input()
            ...
            print("casilla 1")
            print(self.movs_casillas_ficha1[int(num_mov)])
            print(f"casilla_act = {casilla_actual}")
            input()
    ...
    def read_and_filter(self, file_path, n, x, y, chunk_size=10000):
        ...
        for chunk in chunk_iter:
            ...
            print(chunk)
            print(f"Estamos buscando una fila de columna {n} diferente a {x} que en su columna {int(n)-1} tenga {y}")
            input()
                ...
                if mover_pieza1 and self.indice_movimiento_p1 <= self.num_movs:
                    ...
                    if aux != self.pieza16_pos:
                        ...
                        if ruta is not None:
                            ...
                            print(f"nueva 1YA = {self.ruta_pieza1}")
                            input()
                    ...
                    if aux != self.pieza1_pos:
                        ...
                        if ruta is not None:
                            ...
                            print("Si se pudo burro")
                            print(f"nueva 2YA = {self.ruta_pieza16}")
                            input()
    ...
    def draw_neural_graph(self, data):
        G = nx.DiGraph()
        pos = {}
...
if __name__ == "__main__":
    ...
    juego.draw_neural_graph(juego.movs_casillas_ficha1)
    juego.draw_neural_graph(juego.movs_casillas_ficha16)
    juego.bucle_1()
