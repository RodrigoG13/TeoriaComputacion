                ...
                if mover_pieza1 and self.indice_movimiento_p1 <= self.num_movs:
                    ...
                    if aux != self.pieza16_pos:
                        ...
                        if ruta is not None:
                            ...
                            print(f"Nueva ruta {self.ruta_pieza1}")
                    ...
                    if aux != self.pieza1_pos:
                        ...
                        if ruta is not None:
                            ...
                            print(f"Nueva ruta {self.ruta_pieza16}, a punto moverse")
                            print(self.indice_movimiento_p16)
                            print(f"{self.indices[int(self.ruta_pieza16[self.indice_movimiento_p16])]}, type={type(self.indices[int(self.ruta_pieza16[self.indice_movimiento_p16])])}")
                            aux = self.indices[int(self.ruta_pieza16[self.indice_movimiento_p16])]
